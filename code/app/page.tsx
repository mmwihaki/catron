  ...
  const featuredProducts = [
    {
      ...
      image: "https://www.autodoc.co.uk/media/catalog/product/cache/3/image/1200x/17f82f742ffe127f42dca9de82fb58b1/7/o/7o0026_ridex_oil_filter.jpg",
      badge: "BEST SELLER"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: "https://dammedia.osram.info/media/resource/hires/osram-dam-2414533/NB200_all_12V.png",
      badge: "TOP RATED"
    },
    {
      id: 4,
      ...
      image: "https://cdn.sparkplugs.co.uk/images/products/large/ngk-spark-plug-dilkar7e11hs-97439.jpg",
      badge: "IN STOCK"
    },
    {
      id: 5,
      ...
      {cartVisible && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0', fontSize: '24px', fontWeight: '700' }}>Shopping Cart</h3>
            <button
                ...
                {cart.map((item) => (
                  <div key={item.id} style={{
                    ...
                    <div style={{ flex: '1' }}>
                      ...
                      <p style={{ margin: '5px 0 0 0', fontSize: '14px', fontWeight: '700', color: '#e74c3c' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: '14px', marginBottom: '4px', fontWeight: '600' }}>♡</div>
              <span style={{ fontSize: '11px', color: '#bdc3c7' }}>Wishlist</span>
              <span style={{
                position: 'absolute',
                top: '0',
                right: '0',
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {['Home', 'Shop by Vehicle', 'Brands', 'Deals', 'About', 'Contact'].map(item => (
              <a key={item} href="#" style={{
                ...
                fontSize: '15px',
                padding: '8px 0',
                borderBottom: item === 'Home' ? '2px solid #DC143C' : '2px solid transparent',
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              <strong> RIDEX, KAVO, OSRAM, NGK</strong> and more.
              Quality guaranteed with fast shipping across Kenya.
            </p>

            <div style={{ display: 'flex', gap: '20px', marginBottom: '40px' }}>
              <button style={{
                background: 'linear-gradient(135deg, rgb(247, 51, 18), rgb(220, 40, 15))',
                color: 'white',
                border: 'none',
                padding: '18px 35px',
                borderRadius: '12px',
            ...
            <div style={{ display: 'flex', gap: '35px' }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontSize: '14px', fontWeight: '600' }}>{feature.text}</div>
                  <div style={{ fontSize: '12px', opacity: '0.8' }}>{feature.detail}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {[
                ...
                { label: 'Model', options: ['Note E12', 'Teana L33', 'March K13', 'Altima L34', 'Sentra B18', 'X-Trail T33'] },
                { label: 'Engine', options: ['DIG-S', 'QR25DE', 'Puredrive', 'VC-Turbo', 'CVT'] }
              ].map((field, i) => (
                <select key={i} style={{
                  padding: '15px 20px',
                ...
                <div className="category-card" style={{
                  ...
                  <div style={{ marginTop: 'auto', textAlign: 'center' }}>
                    <p style={{
                      ...
                      <a href="#" className="category-title" style={{
                        cursor: 'pointer',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              { name: 'Oil Filter Kit', price: 2500, image: 'https://images.autodoc.de/categorypictures/oil-filter-1.jpg' },
              { name: 'Air Filter Set', price: 3200, image: 'https://images.autodoc.de/categorypictures/air-filter-1.jpg' },
              { name: 'Brake Pads', price: 5500, image: 'https://images.autodoc.de/categorypictures/brake-pads-1.jpg' },
              { name: 'Spark Plugs', price: 4000, image: 'https://images.autodoc.de/categorypictures/spark-plugs-1.jpg' }
            ].map((item, index) => (
              <div key={index} style={{
                background: 'white',
                borderRadius: '12px',
                ...
                <h3 style={{ fontSize: '18px', fontWeight: '700', marginBottom: '10px', color: '#2c3e50' }}>
                  {item.name}
                </h3>
                <p style={{ fontSize: '20px', fontWeight: '700', color: '#DC143C', marginBottom: '15px' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              { name: 'RIDEX Oil Filter', bestseller: true, price: 1300, originalPrice: 1500 },
              { name: 'NGK Spark Plugs', bestseller: true, price: 4600, originalPrice: 5200 },
              { name: 'OSRAM Headlights', bestseller: true, price: 7500, originalPrice: 8500 }
            ].map((item, index) => (
              <div key={index} style={{
                background: 'white',
                borderRadius: '16px',
            ...
            {[
              {
                ...
                description: 'Learn how to change your Nissan engine oil properly',
                readTime: '5 min read'
              },
              {
                title: 'Brake Maintenance',
                description: 'Essential brake system maintenance for your Nissan',
                readTime: '7 min read'
              },
              {
        ...
        <div style={{
          ...
          padding: '0 20px'
            ...
            <p style={{
              ...
              Genuine OEM and premium aftermarket parts specifically for Nissan vehicles from top brands like
              <strong> RIDEX, KAVO, OSRAM, NGK</strong> and more.
              Quality guaranteed with fast shipping across Kenya.
            </p>
            {featuredProducts.map((product, index) => (
              <div key={index} style={{
                ...
                <div style={{
                  ...
                  left: '15px',
                  background:
                    product.badge === 'BEST SELLER' ? '#e74c3c' :
                    product.badge === 'TOP RATED' ? '#f39c12' :
                    product.badge === 'PREMIUM' ? '#9b59b6' :
                    product.badge === 'LIMITED' ? '#e67e22' :
                    product.badge === 'LAST ONE' ? '#c0392b' : '#27ae60',
                  color: 'white',
                  padding: '6px 12px',
                  borderRadius: '20px',
                  fontSize: '11px',
                ...
                <div style={{ padding: '25px' }}>
                  ...
                  <div style={{
                    ...
                    <span style={{ fontWeight: '600', color: '#2c3e50' }}>{product.brand}</span>
                  </div>
                  ...
                  <button
                    ...
                    style={{
                      width: '100%',
                      background: product.stock > 0 ? 'linear-gradient(135deg, rgb(247, 51, 18), rgb(220, 40, 15))' : '#95a5a6',
                      color: 'white',
                      border: 'none',
                      padding: '15px',
                      borderRadius: '10px',
                      ...
                      boxShadow: product.stock > 0 ? '0 4px 15px rgba(247, 51, 18, 0.3)' : 'none'
                    }}
                  >
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Get exclusive deals on Nissan parts, new arrivals, and Nissan tips delivered to your inbox
          </p>
          <div style={{
            display: 'flex',
            justifyContent: 'center',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '25px' }}>
                ...
                <div>
                  <h3 style={{ fontSize: '28px', fontWeight: '800', margin: '0', color: 'rgb(247, 51, 18)' }}>
                    Catron Kenya
                  </h3>
                  <p style={{ fontSize: '12px', margin: '0', color: '#bdc3c7' }}>Premium Nissan Parts</p>
                </div>
              </div>
              <p style={{ opacity: '0.8', lineHeight: '1.6', marginBottom: '25px' }}>
                Your trusted source for premium Nissan parts in Kenya. We specialize in authentic OEM and
                high-quality aftermarket components specifically for Nissan vehicles.
              </p>
            </div>

            <div>
              <h4 style={{ fontSize: '20px', fontWeight: '700', marginBottom: '25px', color: 'rgb(247, 51, 18)' }}>
                Quick Links
              </h4>
              {[
                'About Catron', 'Shipping & Delivery', 'Returns & Exchanges',
                'Warranty Information', 'Privacy Policy', 'Terms of Service', 'Track Your Order'
              ].map(link => (
            ...
            <div>
              ...
              {[
                'Oil Filters', 'Air Filters', 'Brake Systems', 'Lighting Solutions',
                'Spark Plugs', 'Cabin Filters', 'Belt Systems', 'Suspension Parts'
              ].map(category => (
              ...
              <div style={{
                ...
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ fontSize: '11px', fontWeight: '600' }}>{trust.text}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '25px', alignItems: 'center' }}>
              <span style={{ fontSize: '14px', opacity: '0.8' }}>Trusted by 5,000+ customers in Kenya</span>
            </div>
          </div>
        </div>
      </footer>
