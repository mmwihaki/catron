...
export default function HomePage() {
  ...
  const checkoutViaWhatsApp = () => {
    ...
    let message = "Hello! I'd like to order the following items from Brator:\n\n"
          ...
          <div style={{
            ...
            <div style={{
              ...
              {[
                ...
                { label: 'Make', options: ['Nissan', 'Toyota', 'Honda', 'Mazda'] },
                { label: 'Model', options: ['Note E12', 'Teana L33', 'March K13'] },
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '16px', color: '#7f8c8d' }}>
                Premium quality parts from trusted brands - All prices in Kenya Shillings
              </p>
            </div>
            <a href="#" style={{
              color: 'rgb(247, 51, 18)',
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Get exclusive deals, new arrivals, and automotive tips delivered to your inbox
          </p>
          <div style={{
            display: 'flex',
            justifyContent: 'center',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '25px' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '12px', margin: '0', color: '#bdc3c7' }}>Premium Auto Parts</p>
                </div>
              </div>
              <p style={{ opacity: '0.8', lineHeight: '1.6', marginBottom: '25px' }}>
                Your trusted source for premium auto parts in Kenya. We provide authentic OEM and
                high-quality aftermarket components from top brands worldwide.
              </p>
              <div style={{
                background: '#2c3e50',
                padding: '20px',
                ...
                <div style={{ fontSize: '14px', color: 'rgb(247, 51, 18)', fontWeight: '600', marginBottom: '8px' }}>
            ...
            <div>
              ...
              {[
                'About Brator', 'Contact Us', 'Shipping & Delivery', 'Returns & Exchanges',
            ...
            <div>
              ...
              <div style={{ marginBottom: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                  <span style={{ fontSize: '14px', opacity: '0.8' }}>Nairobi Auto Parts Market, Kenya</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                  <span style={{ fontSize: '14px', opacity: '0.8' }}>info@brator.co.ke</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
                  <span style={{ fontSize: '14px', opacity: '0.8' }}>Mon-Sat: 8AM-6PM EAT</span>
                </div>
              </div>
          ...
          <div style={{
            ...
            <div style={{ opacity: '0.8', fontSize: '14px' }}>
              © 2024 Brator Kenya. All rights reserved. | All prices in Kenya Shillings (KES)
            </div>
