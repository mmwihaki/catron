...
Please confirm availability and payment details.`;
  ...
  return (
    <>
      ...
      {/* Cart Sidebar */}
      <div
        className={`fixed top-0 right-0 h-screen w-full sm:w-96 bg-white shadow-2xl z-50 transform transition-transform duration-300 ${isCartOpen ? "translate-x-0" : "translate-x-full"}`}
      >
